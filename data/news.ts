export const news = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nunc eros, hendrerit ac pulvinar non, sagittis in dui. Mauris placerat vehicula nibh, vel posuere magna pellentesque rutrum. Morbi nec fringilla mauris. Morbi commodo neque nec odio finibus varius.",
  },
  {
    id: 2,
    img: "news-2.png",
  ...
  },
  {
    ...
    description:
      "Morbi sit amet sapien at ipsum sollicitudin suscipit. Pellentesque et felis quis massa efficitur tristique sit amet quis nunc. Integer ultrices urna vitae dui sagittis suscipit. Nam et odio molestie, varius metus non, rutrum lacus. Ut laoreet velit velit, sed placerat ipsum sagittis in. Maecenas scelerisque magna mauris, vitae finibus ante euismod eleifend.",
  },
  {
    id: 4,
    img: "news-4.png",
